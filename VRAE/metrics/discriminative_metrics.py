...
Note: Use post-hoc RNN to classify original PEMS-BAY and synthetic PEMS-BAY
...
def discriminative_score_metrics (ori_data, generated_data):
  """Use post-hoc RNN to classify original PEMS-BAY and synthetic PEMS-BAY
  ...
  def discriminator (x, t):
    ...
    with tf.variable_scope("discriminator", reuse = tf.AUTO_REUSE) as vs:
      ...
      y_hat_logit = tf_slim.layers.fully_connected(d_last_states, 1, activation_fn=None)
  ...
  # Train/test division for both original and generated PEMS-BAY
