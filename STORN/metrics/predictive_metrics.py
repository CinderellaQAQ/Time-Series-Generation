...
def predictive_score_metrics (ori_data, generated_data):
  ...
  Returns:
    - predictive_score: MAE of the predictions on the original PEMS-BAY
  """
  ...
  def predictor (x, t):
    ...
    with tf.variable_scope("predictor", reuse = tf.AUTO_REUSE) as vs:
      ...
      y_hat_logit = tf_slim.layers.fully_connected(p_outputs, 1, activation_fn=None)
  ...
  ## Test the trained model on the original PEMS-BAY
